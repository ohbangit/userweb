...
export function CategoryThumbnail({ src, name }: CategoryThumbnailProps) {
    ...
    return (
        <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-gray-100 dark:bg-[#26262e]">
            <svg className="h-5 w-5 text-gray-400 dark:text-[#848494]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                <path
                    strokeLinecap="round"
